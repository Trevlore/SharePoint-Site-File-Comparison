# Shared HTML Report Generator for SharePoint Comparison
# This script contains the function to generate HTML comparison reports

<#
.SYNOPSIS
    Generates an HTML comparison report for SharePoint sites.

.DESCRIPTION
    Creates a formatted HTML report showing files unique to each site and common files
    with differences highlighted.

.PARAMETER Site1Files
    Array of file objects from the first site

.PARAMETER Site2Files
    Array of file objects from the second site

.PARAMETER Site1Name
    Display name for the first site

.PARAMETER Site2Name
    Display name for the second site

.PARAMETER Site1Url
    URL of the first site

.PARAMETER Site2Url
    URL of the second site
